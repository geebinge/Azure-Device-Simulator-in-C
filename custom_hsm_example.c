...
HSM_CLIENT_HANDLE custom_hsm_create(void)
{
    ...
    else
    {
        ...
        hsm_info->certificate = x509certificate;
        hsm_info->key = x509privatekey;
        hsm_info->common_name = DeviceID->valuestring;
        ...
        hsm_info->registration_name = DeviceID->valuestring;
